...
declare enum contentstatustype {
    none = 0,
    periodquest_day = 1,
    periodquest_week = 2,
    chaos = 3,
...
type StatQueryFilter = {
    zone: Map<number, {
        contentstatustype?: keyof typeof contentstatustype;
        name?: string;
    }>;
    raid: Map<number, {
        type: keyof typeof raidtype;
        name: string;
    }>;
};
declare class MeterData {
    ...
    elixir: {
        option: Map<number, ElixirOption>;
        set: Map<number, Map<number, ElixirSet>>;
    };
    esther: Esther[];
    itemSet: ItemSet;
    ...
    processElixir(data: {
        option: {
            [key: string]: ElixirOption;
        };
        set: {
            [key: string]: {
                [key: string]: ElixirSet;
            };
        };
    }): void;
...
export { Breakdown as B, CombatEffect as C, DamageStatistics as D, EntityState as E, GameTrackerOptions as G, HealSource as H, ItemSetData as I, KillState as K, MeterData as M, Npc as N, PARSED_LOG_VERSION as P, RaidDifficulty as R, StatusEffectTarget as S, GameState as a, StatusEffectBuffTypeFlags as b, StatusEffect as c, StatusEffectSource as d, GameStateNew as e, DamageInfo as f, EntitySkills as g, Hits as h, Skill as i, SkillBuff as j, SkillFeature as k, SkillFeatureLevelData as l, SkillFeatureOption as m, PassiveOption as n, ElixirOption as o, ElixirSet as p, CombatEffectDetail as q, CombatEffectCondition as r, CombatEffectAction as s, SkillEffect as t, Esther as u, ItemSet as v, ItemSetLevel as w, ItemSetCount as x, CombatEffectConditionData as y, StatQueryFilter as z };
