...
export const mapping = new Map<number, [string, (buf: Buffer) => any]>([
  ...
  [codes.PKTEquipChangeNotify, [names.PKTEquipChangeNotify, reads.PKTEquipChangeNotify]],
  [codes.PKTEquipLifeToolChangeNotify, [names.PKTEquipLifeToolChangeNotify, reads.PKTEquipLifeToolChangeNotify]],
  [codes.PKTIdentityStanceChangeNotify, [names.PKTIdentityStanceChangeNotify, reads.PKTIdentityStanceChangeNotify]],
  ...
  [codes.PKTInitItem, [names.PKTInitItem, reads.PKTInitItem]],
  ...
  [codes.PKTSkillCancelNotify, [names.PKTSkillCancelNotify, reads.PKTSkillCancelNotify]],
