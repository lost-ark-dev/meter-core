...
import * as Struct_585 from "../structures/Struct_585";
import * as Struct_636 from "../structures/Struct_636";
export type Struct_533 = {
  struct_643?: Struct_643.Struct_643;
  struct_125?: Buffer;
  struct_1?: { unk1_0_0: number; unk1_0_1: number; struct_514: Buffer; unk1_0_3: number }[];
  unk2_2?: number;
  unk3_0?: Buffer;
  unk4_0?: Buffer;
  unk4_1?: number;
  ...
  struct_585?: Struct_585.Struct_585;
  unk7_0?: Buffer;
...
export function read(reader: Read) {
  ...
  if (unk0 === 2) {
    ...
    data.struct_1 = reader.array(
      reader.u16(),
      () => {
        const m = {} as { unk1_0_0: number; unk1_0_1: number; struct_514: Buffer; unk1_0_3: number };
  ...
  if (unk0 === 6) data.struct_585 = Struct_585.read(reader);
