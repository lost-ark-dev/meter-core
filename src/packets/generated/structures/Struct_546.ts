...
export type Struct_546 = {
  ...
  unk2_0?: number;
  struct_128?: Buffer;
  struct_1?: { unk1_0_0: number; unk1_0_1: number; unk1_0_2: number; struct_509: Buffer }[];
  unk3_0?: Buffer;
  unk4_0?: Buffer;
  unk4_1?: Buffer;
  unk4_2?: number;
...
export function read(reader: Read) {
  ...
  if (unk0 === 2) {
    ...
    data.struct_1 = reader.array(
      reader.u16(),
      () => {
        const m = {} as { unk1_0_0: number; unk1_0_1: number; unk1_0_2: number; struct_509: Buffer };
